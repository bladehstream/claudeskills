...
See: `agent_model_selection.md` for detailed criteria.
...
### Design Agent
```
You are a game design agent. Create specifications for [FEATURE].

## Context
[Current game state, existing mechanics]

## Requirements
[User requirements]

## Deliverables
- Feature specification with parameters
- Edge cases
...
### Problem
Large game files (2000+ lines) can exceed subagent context limits.

### Solutions
1. **Specific line ranges**: "Read lines 1370-1400 for gameOver()"
2. **Pre-summarize**: Include relevant code snippets in prompt
3. **Smaller tasks**: Break large features into focused subtasks
4. **Tiered exploration**: Haiku for discovery, Sonnet for implementation
...
├── html5_game_dev_workflow.md  # This file
├── sr_game_designer.md         # Design agent profile
├── svg_asset_generator.md      # Asset agent profile
├── qa_agent.md                 # QA agent profile
├── game_feel_developer.md      # Polish agent profile
└── user_persona_reviewer.md    # Player testing profile
```

---

*Distilled from Turtle Rescue development session, December 2024*
